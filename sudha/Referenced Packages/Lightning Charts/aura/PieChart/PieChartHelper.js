({
    ...
    createChart : function(jsonData, component, dataSourceType) {
	    console.log("PieChart:  createChart: enter component id " + component.get("v.docmId"));
	    ...
	    console.log("PieChart:  createChart: component id " + component.get("v.docmId") + " wrapperDivElementId " + wrapperDivElementId);
	    ...
	    console.log("PieChart:  createChart: component id " + component.get("v.docmId") + " isFieldVisible " + isFieldVisible);
        ...
        if (this.isUIControlDisplayed === false) {   
	        ...
	        console.log("PieChart:  createChart: display chart " + component.get("v.docmId") + " " + jsonData);
            self.displayChart(component, jsData);
          	console.log("PieChart:  createChart: make wrapper visible" + component.get("v.docmId"));
    ...
    parseDataFromDataSource: function(component, dataSourceType, jsonData) {
   	...
   	displayChart: function(component, jsData) {
        console.log("PieChart:  displayChart: component id " + component.get("v.docmId") + " " + jsData);
    	if (jsData != "") {
        	var chartData = "[";
	...
	//from the server side    
  	refreshUI : function(component) {
        console.log("PieChart:  refreshUI: enter");
