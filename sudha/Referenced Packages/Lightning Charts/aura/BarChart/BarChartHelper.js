({
    ...
    createChart : function(jsonData, component, dataSourceType) {
	    console.log("BarChart: createChart: enter component id " + component.get("v.docmId"));
	    ...
	    console.log("BarChart: createChart: component id " + component.get("v.docmId") + " wrapperDivElementId " + wrapperDivElementId);
	    ...
	    console.log("BarChart: createChart: component id " + component.get("v.docmId") + " isFieldVisible " + isFieldVisible);
        ...
        if (this.isUIControlDisplayed === false) {   
            ...
            var self = this;
	        console.log("BarChart: createChart: component id " + component.get("v.docmId") + " " + jsonData);
			var jsData = self.parseDataFromDataSource(component, dataSourceType, jsonData);
			//convert the Div element into a Chart            
	        console.log("BarChart: createChart: display chart " + component.get("v.docmId") + " " + jsonData);
            self.displayChart(component, jsData);
          	console.log("BarChart: createChart: make wrapper visible" + component.get("v.docmId"));
    ...
    parseDataFromDataSource: function(component, dataSourceType, jsonData) {
   	...
   	displayChart: function(component, jsData) {
        console.log("BarChart: displayChart: component id " + component.get("v.docmId") + " " + jsData);
    	if (jsData != "") {
        	var chartData = "[";
    		...
    		chartData += "]";
        	console.log("BarChart: displayChart: component id " + component.get("v.docmId") + " chartData " + chartData);
	...
	//from the server side    
  	refreshUI : function(component) {
        console.log("BarChart: refreshUI: enter");
